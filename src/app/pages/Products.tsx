...
const allProducts = [
  ...
  { id: 10, slug: "PAC", name: "Refuse / Garbage Compactor – PAC™", category: "solid-waste", categoryLabel: "Solid Waste", image: "/images/products/refuse-compactor.jpeg", desc: "Compactor solution for high-volume municipal solid waste collection.", capacity: "Model Dependent", featured: true },
  ...
  // Industrial Vacuum
  { id: 12, slug: "HYPERVAC-IVC", name: "Industrial Vacuum Cleaner (IVC – Super Sucker) – HYPERVAC™ IVC", category: "industrial-vacuum", categoryLabel: "Industrial Vacuum", image: "/images/products/mm-suction-vacuum-pump.jpeg", desc: "Heavy-duty industrial vacuum cleaning platform for demanding suction jobs.", capacity: "Model Dependent", featured: true },
  { id: 16, slug: "CHASSIS-VACUUM-CLEANER", name: "Chassis Mounted Industrial Vacuum Cleaner", category: "industrial-vacuum", categoryLabel: "Industrial Vacuum", image: "/images/products/mm-suction-vacuum-pump.jpeg", desc: "Truck-mounted vacuum cleaner for industrial and municipal cleaning.", capacity: "Model Dependent", featured: false },
  { id: 17, slug: "ATEX-VACUUM-SYSTEMS", name: "ATEX Compliant Vacuum Systems", category: "industrial-vacuum", categoryLabel: "Industrial Vacuum", image: "/images/products/mm-suction-vacuum-pump.jpeg", desc: "Explosion-proof vacuum systems for hazardous industrial environments.", capacity: "Model Dependent", featured: false },
