...
export const seoConfig: Record<string, SEOMetadata> = {
  ...
  about: {
    ...
    description: "McRAYGOR Mechanicals Infrastructure is a leading manufacturer of specialized waste handling and industrial cleaning equipment, serving municipal and industrial sectors globally with 25+ years of engineering legacy.",
    keywords: "McRAYGOR company, waste handling equipment manufacturer, industrial cleaning machines India, municipal infrastructure engineering, vacuum trucks manufacturer, sewer cleaning machines legacy",
    canonical: `${BASE_URL}/about`,
    ogTitle: "About McRAYGOR | Global Leader in Waste Handling Technology",
    ogDescription: "25+ years of engineering excellence in municipal and industrial waste handling solutions. Proudly supporting Clean City initiatives.",
    ogImage: DEFAULT_OG_IMAGE,
    ogType: "website",
  },
  vision: {
    title: "Vision & Mission | McRAYGOR Mechanicals Infrastructure India",
    description: "Our commitment to cleaner cities, safer sanitation practices, and mechanized infrastructure aligned with Make in India. Envisioning a future without manual scavenging.",
    keywords: "McRAYGOR vision, mission goal, eliminate manual scavenging, sanitation worker dignity, mechanized sanitation India, sustainable infrastructure goals, Make in India engineering",
    canonical: `${BASE_URL}/vision`,
    ogTitle: "Vision & Mission - McRAYGOR | Transforming Sanitation Infrastructure",
    ogDescription: "Dedicated to safer sanitation and cleaner cities through mechanized innovation and national alignment with Make in India.",
    ogImage: DEFAULT_OG_IMAGE,
    ogType: "website",
  },
  legacy: {
