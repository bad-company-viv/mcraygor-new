...
export function QuotationSection() {
    return (
        <section className="py-16 md:py-24 bg-[#1c2535] text-white">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                <div className="grid lg:grid-cols-12 gap-10 md:gap-12 lg:gap-20 items-start">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <p className="text-gray-400 text-base md:text-lg mb-8 md:mb-12 max-w-2xl leading-relaxed">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 mb-10">
                            {infoCards.map((card) => (
                                <div key={card.label} className="bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6 flex gap-4 hover:bg-white/10 transition-colors">
                        ...
                        <a
                            href="/Brochure.pdf"
                            download
                            className="inline-flex items-center gap-2 px-5 sm:px-6 py-3 border border-white/20 rounded-xl font-bold bg-white/5 hover:bg-white/10 transition-all text-sm mb-8 md:mb-12 group"
                        >
                    ...
                    <div className="lg:col-span-5">
                        <div className="bg-[#242e42] p-6 sm:p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-white/10 shadow-2xl">
                            <h3 className="text-2xl font-bold mb-6 sm:mb-8">Inquiry Form</h3>
                            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                                <div>
                                    <label className="block text-xs font-bold text-gray-400 mb-2 tracking-wider">Name *</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-400 mb-2 tracking-wider">Email *</label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-400 mb-2 tracking-wider">Message *</label>
                                    <textarea
                                        rows={5}
