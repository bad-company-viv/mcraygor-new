...
export const InteractiveIndiaMap = () => {
  return (
    <div className="relative w-full aspect-[4/5] max-w-2xl mx-auto overflow-hidden rounded-2xl bg-[#0f172a] shadow-2xl border border-gray-800">
      ...
      <div className="absolute bottom-6 left-6 z-20">
        <div className="bg-black/50 backdrop-blur-md px-5 py-4 rounded-2xl border border-white/10">
          <div className="flex items-center gap-2 mb-1">
            <div className="w-2.5 h-2.5 rounded-full bg-[#e8612c] animate-pulse" />
