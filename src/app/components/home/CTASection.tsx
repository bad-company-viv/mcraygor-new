  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8 text-center">
        ...
        <p className="text-green-100/80 max-w-xl mx-auto mb-10 leading-relaxed">
          Connect with McRAYGOR for product enquiries, government tender support, and service requirements.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#"
            className="flex items-center gap-2.5 bg-[#e8612c] hover:bg-[#d4531f] text-white px-7 py-3.5 rounded-lg font-semibold text-base transition-all hover:shadow-xl"
          >
            <Download size={18} />
          ...
          <Link
            to="/contact"
            className="flex items-center gap-2.5 border-2 border-white text-white hover:bg-white hover:text-[#1a5c3a] px-7 py-3.5 rounded-lg font-semibold text-base transition-all"
          >
